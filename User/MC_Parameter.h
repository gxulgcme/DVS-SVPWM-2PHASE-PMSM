...
#define VOLTAGE_SHUNT_RATIO            (1.0/(151.0)) /* 母线电压分压比 */
...
#define U_RATED_VOLTAGE                (238.0)               /* 单位:V, 电机额定工作电压，设置为正常工作电压 */
...
#define U_MOTOR_LD                     (1850.3)           //单位: uH 电机d轴电感 1900.3
#define U_MOTOR_LQ                     (2850.4)           //单位: uH 电机q轴电感  2300.4
...
/* ----------------------------预驱自举电容预充电参数--------------------------- */
#define CHARGE_TIME                    (5)              /* 每相预充电时间，根据实际硬件参数修改 */
...
#define P_CURRENT_KI                   1400                /* 电流环Ki，实际运用的Kp会根据这个值和电机参数计算出最终的Ki */

#define P_CURRENT_KP_H                 3338              /* 高速电流环Kp， 1500= 1.5倍*/  //1200
#define P_CURRENT_KI_H                 60000               /* 高速 电流环Ki，1500= 1.5倍 */ //1200

#define AUTO_FW_LIM                    ((s16)200)        /* 自动弱磁D轴电流限制，Q12格式，最大值 4096 */
...
#define BRAKE_P_CURRENT_KI             132// 44                /* 刹车电流环Ki */
...
#define U_DCB_OVERVOLTAGE_RECOVER      (355.0)               /* 单位：V 过压恢复设定值 */
#define U_DCB_UNDERVOLTAGE_FAULT       (220.0)               /* 单位：V 欠压检测设定值 */
#define U_DCB_UNDERVOLTAGE_RECOVER     (223.0)               /* 单位：V 欠压恢复设定值 */
...
/* 发热丝温度检测参数 */
#define TEMP_FAULT                     (8190)              /* 过温检测设定值 */
#define TEMP_RECOVER                   (25686)              /* 过温恢复设定值 */
#define TEMP_BREAK                     (32767)             /* NTC开路设定值 */

/* IPM温度检测参数 */
#define IPMTEMP_OVER                   (22754)    /* 过温保护典型电压值2.5V  */
#define IPMTEMP_RECOVER                (18203)    /* 过温释放典型电压值2.0V  3.6V-32767*/
...
/* 缺相检测参数 */
#define I_PHASE_LOSS_FAULT             (800)             /* 数字量，根据实际测试中struCurrentAmplitude.nPhA/struCurrentAmplitude.nPhB/struCurrentAmplitude.nPhC */
                                                          /* 的计算值来设定，在缺相和正常运行的中间取值。 */
#define PHASE_CHCEK_TIME               (400)               /* 单位：5ms 缺相检测时间*/

#define PHASEABC_DISSYMMETRY_PER        120               /*三相不对称百分比*/
